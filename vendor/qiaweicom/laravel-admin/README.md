...
```json
{
    "repositories": [
        {
            "type": "vcs",
            "url": "https://github.com/qiaweicom/laravel-admin"
        }
    ],
    "require": {
        "qiaweicom/laravel-admin": "dev-master"
    }
}
```
...
```
php artisan vendor:publish --provider="Qiaweicom\Admin\AdminServiceProvider"
