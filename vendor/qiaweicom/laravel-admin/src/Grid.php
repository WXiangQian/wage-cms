...
use Qiaweicom\Admin\Grid\Displayers\Actions;
use Qiaweicom\Admin\Grid\Displayers\RowSelector;
use Qiaweicom\Admin\Grid\Exporter;
use Qiaweicom\Admin\Grid\Filter;
use Qiaweicom\Admin\Grid\Model;
use Qiaweicom\Admin\Grid\Row;
use Qiaweicom\Admin\Grid\Tools;
...
class Grid
{
     ...
     *
     * @var \Qiaweicom\Admin\Grid\Model
     */
    protected $model;
     ...
     * The grid Filter.
     *
     * @var \Qiaweicom\Admin\Grid\Filter
     */
    protected $filter;
    ...
    {
        $map = [
            'editable'    => \Qiaweicom\Admin\Grid\Displayers\Editable::class,
            'switch'      => \Qiaweicom\Admin\Grid\Displayers\SwitchDisplay::class,
            'switchGroup' => \Qiaweicom\Admin\Grid\Displayers\SwitchGroup::class,
            'select'      => \Qiaweicom\Admin\Grid\Displayers\Select::class,
            'image'       => \Qiaweicom\Admin\Grid\Displayers\Image::class,
            'label'       => \Qiaweicom\Admin\Grid\Displayers\Label::class,
            'button'      => \Qiaweicom\Admin\Grid\Displayers\Button::class,
            'link'        => \Qiaweicom\Admin\Grid\Displayers\Link::class,
            'badge'       => \Qiaweicom\Admin\Grid\Displayers\Badge::class,
            'progressBar' => \Qiaweicom\Admin\Grid\Displayers\ProgressBar::class,
            'radio'       => \Qiaweicom\Admin\Grid\Displayers\Radio::class,
            'checkbox'    => \Qiaweicom\Admin\Grid\Displayers\Checkbox::class,
            'orderable'   => \Qiaweicom\Admin\Grid\Displayers\Orderable::class,
        ];
