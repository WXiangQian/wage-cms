...
`Qiaweicom\Admin\Widgets\Box` used to generate box components:
...
`Qiaweicom\Admin\Widgets\Collapse` class used to generate folding components:
```php
...
`Qiaweicom\Admin\Widgets\Form` class is used to quickly build a form：
...
The `Qiaweicom\Admin\Widgets\InfoBox` class is used to generate the information presentation block:
...
The `Qiaweicom\Admin\Widgets\Tab` class is used to generate the tab components:
...
`Qiaweicom\Admin\Widgets\Table` class is used to generate forms：
